...
<div class="container">
    ...
    <button type="submit" onclick="myFunction(); return false" class="button button1" name="submit" ><a href="uploadPayment.jsp">Update</a></button>
    <button type="submit" class="button button1" name="submit" ><a href="listPayment.jsp">Back</a></button>
</div>
</body>
</html>